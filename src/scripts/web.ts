...
const ForceFocusOutline = fs.readFileSync(join(__dirname, '../../dist', 'ForceFocusOutline.js'), 'utf-8')
const TextSpacing = fs.readFileSync(join(__dirname, '../../dist', 'TextSpacing.js'), 'utf-8')
const AriaLiveObserver = fs.readFileSync(join(__dirname, '../../dist','MonitorAriaLive.js'), 'utf-8')
